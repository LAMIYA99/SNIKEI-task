...
<div className="col-span-12 md:col-span-4 text-[14px]  ">
  ...
  <div className="text-gray-700 flex flex-col md:flex-row gap-20">
    ...
    <div className="space-y-2">
      <p><strong>NJ Store Location</strong></p>
      <p>56757 Dream Avenue, <br /> Garden City, 234564 <br />New Jersey, USA</p>
    ...
    {/* NY Store */}
    <div className="space-y-2">
      <p><strong>NY Store Location</strong></p>
      <p>12273 Dream Avenue, <br /> Bronx, 123456 <br />New York, USA</p>
  ...
  <div className="flex gap-3 mt-4 text-gray-700">
    ...
    <div className="border-t border-gray-200 mt-8 py-4 text-center text-gray-500 text-sm flex flex-col md:flex-row justify-center md:justify-between items-center gap-2">
      <p>Design by <a href="#" className="underline">Meta Flow</a> | Powered by <a href="#" className="underline">Webflow</a></p>
      <p>Copyright @Snikei. All Rights Reserved</p>
      <p>
        <a href="#" className="underline mx-2">Privacy Policy</a> | 
        <a href="#" className="underline mx-2">Terms and Conditions</a>
      </p>
    </div>
  </footer>
  )
